<template>
    <div>
                ...
                <div class="item-list">
                    ...
                    >
                        ...
                        <div v-if="data.user.education.school_name!=null && data.user.education.graduation_time!=null" class="card-body-center">
                            ...
                            <v-btn large depressed color="pink lighten-5" light @click="dialogEducation=true">Update</v-btn>
                        </div>
                ...
                <div class="item-list">
                    ...
                    >
                        ...
                        <div v-if="data.user.career.company_name!=null && data.user.career.starting_from!=null" class="card-body-center">
                            ...
                            <v-btn large depressed color="cyan lighten-5" light @click="dialogCareer=true">Update</v-btn>
                        </div>
                        <div v-else class="card-body-center">
                            <p>Belum terdapat data</p>
                            <v-btn large depressed color="cyan lighten-5" light @click="dialogCareer=true">Update</v-btn>
      ...
      <v-card>
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="blue darken-1" text @click="dialogEducation = false">Close</v-btn>
          <v-btn color="blue darken-1" text @click="insertEducation()">Save</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
    <v-dialog v-model="dialogCareer" persistent max-width="600px">
      <v-card>
            ...
            <v-row>
              ...
              <v-col cols="12">
                ...
                <v-date-picker v-model="formCareer.ending_in" scrollable>
                    ...
                    <v-btn text color="primary" @click="$refs.dialog2.save(formCareer.ending_in)">OK</v-btn>
                </v-date-picker>
                </v-dialog>
              </v-col>
            </v-row>
        ...
        <v-card-actions>
          ...
          <v-btn color="blue darken-1" text @click="insertCareer()">Save</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
    <v-snackbar
